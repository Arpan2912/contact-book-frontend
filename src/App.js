          ...
          <header style={{ height: '50px' }}>
            <Row>
              <Col sm="2" style={{ lineHeight: '67px' }}>
                <span style={{ fontWeight: 'bold', fontSize: '20px', paddingLeft: '20px' }}>Contact Book</span>
              </Col>
              {token && <Fragment>
                <Col sm="8" className="text-align-right">
                  <NavLink exact activeClassName="active" className="nav-link" to="/contact">Dashboard</NavLink>
                </Col>
